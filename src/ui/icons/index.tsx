...
export function IconUndo({width = 20, height = 20, ...props}: IconProps) {
  return (
    <svg
...
export function IconRedo({width = 20, height = 20, ...props}: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function IconBold({width = 20, height = 20, ...props}: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function IconItalic({width = 20, height = 20, ...props}: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function IconUnderline({width = 20, height = 20, ...props}: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function IconCode({width = 20, height = 20, ...props}: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
